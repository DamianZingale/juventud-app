            ...
            <form method="post" action="CasasServlet">
                <div class="form-group">
                    ...
                    <select name="casaId" id="casaId" class="form-control">
                        <option value="1">Casa 1 - Vinchuca 990</option>
                        <option value="2">Casa 2 - Cierrita -330</option>
                        <option value="3">Casa 3 - Palta 150</option>
                        <option value="4">Casa 4 - Miguel Ríos 100</option>
                    </select>
                </div>
