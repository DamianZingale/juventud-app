            ...
            <form method="post" action="CasasServlet">
                <div class="form-group">
                    ...
                    <select name="casaId" id="casaId" class="form-control">
                        <option value="1">Casa 1 - En algun lugar</option>
                        <option value="2">Casa 2 - Ya me aburri</option>
                        <option value="3">Casa 3 - De pensar</option>
                        <option value="4">Casa 4 - Direcciones al 100</option>
                    </select>
                </div>
